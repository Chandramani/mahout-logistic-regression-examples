...
public class OnlineTrainLogisticExampleAlt {
...
public static Map<String, String> setTypeMap(Iterable<String> predictorList, List<String> typeList) {
    ...
    {
        String inputFile = "/home/ctiwary/bank-additional-full.csv";
        String outputFile = "/home/ctiwary/logistic/model";
...
/*        LogisticModelParameters lmp = new LogisticModelParameters();
        ...
        lr =new OnlineLogisticRegression(2,20,new L1()).lambda(0).learningRate(50).alpha(1 - 1.0e-3); 
